...
print("Image exists:", os.path.exists("/kaggle/input/data/oxford-iiit-pet/images/american_bulldog_71.jpg"))
...
ckpt_path = "/kaggle/input/checkpoint/classifier.pth"
img_path  = "/kaggle/input/data/oxford-iiit-pet/images/american_bulldog_71.jpg"
...
model = VGG11Classifier()
checkpoint = torch.load("/kaggle/input/checkpoint/classifier.pth", map_location=device)
